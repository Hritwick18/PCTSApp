...
namespace PCTSApp.Models
{
    ...
    public partial class ANCRegDetail
    {
        ...
        public byte IcdsAncFlag { get; set; }
        public string PermanentAddressE { get; set; }
        public string PermanentAddressH { get; set; }
        public string CurrentAddressE { get; set; }
        public string CurrentAddressH { get; set; }
        ...
        public Nullable<byte> IsHusband { get; set; }
        public string HusbnameE { get; set; }
        public string HusbNameH { get; set; }
        ...
        public int IcdsInfantID { get; set; }
        public int IcdsImmunizationInfantID { get; set; }
        public byte IcdsSecondChildFlag { get; set; }
        public Nullable<byte> Age { get; set; }
        public byte ANCStatus_deleted { get; set; }
        public byte PNCStatus_deleted { get; set; }
        public Nullable<int> WomanVillageAutoIDtemp { get; set; }
        public Nullable<int> DelplaceCode_deleted { get; set; }
        public Nullable<int> villageautoidtemp { get; set; }
        public Nullable<System.DateTime> DeliveryAbortionDate_deleted { get; set; }
        public Nullable<byte> ReMarriageFlag { get; set; }
        public string NameE { get; set; }
        public string NameH { get; set; }
        public byte[] BplCardNoE { get; set; }
    }
}
