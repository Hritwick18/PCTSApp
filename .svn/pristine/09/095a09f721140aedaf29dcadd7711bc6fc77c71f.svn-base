...
namespace PCTSApp.Models
{
    ...
    public partial class InfantImmu
    {
        ...
        public Nullable<System.DateTime> Booster2DosesDate { get; set; }
        public int Booster2Ashaautoid { get; set; }
        public Nullable<int> FullImmuEntryUnitID { get; set; }
    }
}
